...
export default function NameRules( { rules, onChange } ) {
    ...
    return (
        <div className="cfv-rules-group">
            <p className="cfv-rules-note">Name field defaults: alpha only, min 2 chars (first name), max 56 chars. Leading/trailing spaces are always blocked. Override below.</p>
